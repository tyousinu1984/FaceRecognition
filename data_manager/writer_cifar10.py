...
def get_data_labels(classification):
    idx = 0
    im_data = []
    im_labels = []
...
def tfrecord_writer(im_data, im_labels):
...
if __name__ == "__main__":
    ...
    im_data, im_labels = get_data_labels(classification)

    tfrecord_writer(im_data, im_labels)